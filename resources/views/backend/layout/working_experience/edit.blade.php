                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" name="job_title" id="job_title"
                                            ...
                                            value="{{ old('job_title', $experiences->job_title) }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" name="company_name" id="company_name"
                                            ...
                                            value="{{ old('company_name', $experiences->company_name) }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea name="job_description" id="job_description"
                                            class="form-control @error('job_description') is-invalid @enderror" placeholder="Enter a description">{{ old('job_description', $experiences->job_description) }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" name="employment_type" id="employment_type"
                                            ...
                                            value="{{ old('employment_type', $experiences->employment_type) }}"
