                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <a href="{{ route('admin.working.experience.create') }}" class="btn btn-primary btn-sm">Add
                                    New
                                </a>
                            </div>
                            <div class="card-body">
                                                ...
                                                <tbody>
                                                    @foreach ($experiences as $item)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">{{ $item->employment_type }}</td>
                                                            <td>
                                                                <a href=""
                                                                    class="btn btn-sm btn-soft-primary">View</a>
                                                                <a href="{{ route('admin.working.experience.edit', $item->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-5">
                                            <div class="dataTables_info" id="alternative-pagination_info" role="status"
                                                aria-live="polite">Showing {{ $experiences->firstItem() }} to
                                                {{ $experiences->lastItem() }} of {{ $experiences->total() }} entries
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-7">
                                            <div class="dataTables_paginate paging_full_numbers"
                                                ...
                                                <ul class="pagination">
                                                    <li
                                                        class="paginate_button page-item {{ $experiences->onFirstPage() ? 'disabled' : '' }}">
                                                    ...
                                                    @for ($i = 1; $i <= $experiences->lastPage(); $i++)
                                                        <li
                                                            class="paginate_button page-item {{ $experiences->currentPage() == $i ? 'active' : '' }}">
                                                    ...
                                                    @endfor
                                                    <li
                                                        class="paginate_button page-item {{ $experiences->hasMorePages() ? '' : 'disabled' }}">
